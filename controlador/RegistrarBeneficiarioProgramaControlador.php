...
$programas = $beneficiarioProgramaModelo->obtenerProgramasActivos();

// Determinar qué vista cargar según el rol del usuario
if ($_SESSION['rol'] === 'administrador') {
    require_once __DIR__ . '/../vista/admin/registrar_beneficiario_programa.php';
} elseif ($_SESSION['rol'] === 'usuario') {
    require_once __DIR__ . '/../vista/usuario/registrar_beneficiario_programa.php';
} else {
    header('Location: ../vista/inicio.html');
    exit();
}
